...
exports.runIperfStream = exports.runIperf = void 0;
const child_process_1 = require("child_process");
const runIperf = (options) => {
    ...
    return new Promise((resolve) => {
        ...
        const iperfProcess = (0, child_process_1.spawn)('iperf3', args);
        let stdout = '';
        let stderr = '';
...
exports.runIperf = runIperf;
const events_1 = require("events");
// Emits 'data' (string), 'error' (string), 'end' (void)
const runIperfStream = (options) => {
...
exports.runIperfStream = runIperfStream;
